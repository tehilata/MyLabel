...
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
  ...
  s.homepage         = 'https://github.com/tehilata/MyLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tehila Taub' => 'tehila.taub@topimagesystems.com' }
  s.source           = { :git => 'https://github.com/tehilata/MyLabel.git', :tag => s.version.to_s }
